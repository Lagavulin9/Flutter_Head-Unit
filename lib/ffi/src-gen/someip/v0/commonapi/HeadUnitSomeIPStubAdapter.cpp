 ...
 */
#include <v0/commonapi/HeadUnitSomeIPStubAdapter.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createHeadUnitSomeIPStubAdapter(
    ...
    return std::make_shared< HeadUnitSomeIPStubAdapter<::v0::commonapi::HeadUnitStub>>(_address, _connection, _stub);
}
